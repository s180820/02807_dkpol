...
STOPWORDS.extend(["ste", "sto", "henholdsvis", "pga", "sep", "øh", "haha", "okay","att"]) # from wordclouds

def read_data(filename = "Data/cleaned_data.csv"):
    ...
    if not os.path.exists(filename):
        os.system(f"python utils/data.py Data/tweets > Data/tmp_cleaned_data.txt")
